var blog_api_url = 'https://us-central1-thecloudcontext.cloudfunctions.net/posts';
...
if (post_id) {
  ...
  loadJsonFromFirebase(blog_api_url, function(data) {
    let list = document.createElement('div');
    // Reversing, because they are oldest-first in Firebase but we want to show newest-first.
